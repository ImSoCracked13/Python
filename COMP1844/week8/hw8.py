...
# Display the name of the stations (mirrored positions)
plt.text(-15, 10, s='Green Station 1', rotation=-15)
plt.text(-32, 45, s='Terminal(All Stations)', rotation=-15)
...
# Visualize the graph
plt.title("Mirrored City Transportation Layout")
plt.show()